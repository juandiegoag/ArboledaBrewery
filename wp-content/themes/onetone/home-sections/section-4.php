...
?>
<section style="width: 100%; height: 850px; background-image: url('https://arboleda-juandiegoag.c9users.io/wp-content/uploads/2017/04/Screenshot_20170419_141233.png');background-repeat: repeat;background-size: contain;" id="<?php echo $section_id; ?>" class="home-section-<?php echo ($i+1); ?> <?php echo $section_css_class;?>">
  ...
  <div class="magee-feature-box style1" id="" data-os-animation="fadeOut">
    <div class="img-frames"><div class="img-box figcaption-middle text-center fade-in">'.$img_wrap.'</div></div>
     ...
     if( ($c+1) % 3 == 0){
        ...
        <?php endif;?>
            <div class="home-section-content" style = "height:642px" >
      <h3 style="color:white;">Cervezas artesanales inspiradas en árboles nativos costarricenses</h3> 
                <!--CAOBA-->
                <div class="card effect__hover" style="float:left;width:28%;height:inherit">
                  <div class="card__front">
                      <img style="border-radius: 10px;max-width:100%;max-height:100%;width:inherit;height:inherit;" src="https://arboleda-juandiegoag.c9users.io/wp-content/uploads/2017/04/caobaTrans-1.png"></img>
                  </div>
                  <div class="card__back">
                      <img style="border-radius: 10px;max-width:100%;max-height:100%;width:inherit;height:inherit;" src="https://arboleda-juandiegoag.c9users.io/wp-content/uploads/2017/04/caobainfo.jpeg"></img>
                  </div> 
                </div>
                
                <!--SURA-->
                <div class="card effect__hover" style="float:right;width:28%;height:inherit">
                  <div class="card__front">
                      <img style="border-radius: 10px;max-width:100%;max-height:100%;width:inherit;height:inherit;" src="https://arboleda-juandiegoag.c9users.io/wp-content/uploads/2017/04/suraTrans1.png"></img>
                  </div>
                  <div class="card__back">
                      <img style="border-radius: 10px;max-width:100%;max-height:100%;width:inherit;height:inherit;" src="https://arboleda-juandiegoag.c9users.io/wp-content/uploads/2017/04/surainfo.jpeg"></img>
                  </div> 
                </div>
            </div>          
            <?php 
