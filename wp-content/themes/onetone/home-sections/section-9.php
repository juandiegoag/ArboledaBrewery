...
?>
<section id="<?php echo $section_id; ?>" class="home-section-<?php echo ($i+1); ?> <?php echo $section_css_class;?>" style="height: 100%;
        ...
        <div class="section-subtitle"><?php echo do_shortcode($section_subtitle);?></div>
         ...
         <div class="contact-area">
           <form class="contact-form" action="" method="post">
            <input id="name" style="color:white" tabindex="1" name="name" size="22" type="text" value="" placeholder="<?php _e('Name', 'onetone')?>" />
            <input id="email" style="color:white" tabindex="2" name="email" size="22" type="text" value="" placeholder="<?php _e('Email', 'onetone')?>" />
            <textarea id="message" style="color:white" tabindex="4" cols="39" name="x-message" rows="7" placeholder="<?php _e('Message', 'onetone')?>"></textarea>
            <input id="sendto" style="color:white" name="sendto" type="hidden" value="<?php echo $email;?>" />
            <input id="submit" style="color:white" name="submit" type="button" value="<?php echo $btn_text;?>" />
            </form>
            </div>
           </div>
          </div>
